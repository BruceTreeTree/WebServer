 ...
 * @LastEditTime: 2022-05-04 17:06:04
 * @LastEditors: Lin xiaohu
 * @Description:
 * @FilePath: /WebServer/WebServer/Timer.cpp
 * @===================
 */
/***
 * @Author: Lin xiaohu
 * @Date: 2022-04-29 16:48:27
 * @LastEditTime: 2022-04-30 15:41:58
 * @LastEditors: Lin xiaohu
 * @Description:
 * @FilePath: /WebServer/WebServer/Timer.cpp
 * @===================
...
void TimerNode::clearReq() {
  SPHttpData.reset();  // 释放  就是  引用减一，  如果为0  就释放
  this->setDeleted();
}
...
void TimerManager::handleExpiredEvent() {
  ...
  while (!timerNodeQueue.empty()) {
    ...
    if (ptimer_now->isDeleted())  // 该连接已经删除
      timerNodeQueue.pop();
    else if (ptimer_now->isValid() == false)  //该连接不能用了
      timerNodeQueue.pop();
    else
      break;
  }
